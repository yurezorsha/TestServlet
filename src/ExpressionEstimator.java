...
public class ExpressionEstimator{
	...
	private enum OPERATOR{ 
	  ...
	  ,RANDOM, CEIL, FLOOR, ROUND, ABS, EXP, LOG, SQRT, POW, ATAN2, MIN, MAX//Functions from 'sin' to 'max' (should go in a row), first function should be 'sin', last should be 'max'
